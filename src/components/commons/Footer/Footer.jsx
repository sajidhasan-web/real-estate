...
const Footer = () => {
  return (
    <footer className=" dark:bg-gray-200 dark:text-gray-800">
      <div className="container px-5 mx-auto divide-y mt-10 md:mt-14">
        ...
        <div className="py-6 text-sm text-center dark:text-gray-600">
          © 2024 Skyline-Solutions. All rights reserved.
        </div>
      </div>
    </footer>
  );
