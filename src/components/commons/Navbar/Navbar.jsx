    ...
    <div className="p-4 bg-white mb-10 border-b sticky top-0 z-10">
      <div className=" flex justify-between h-16 ">
        ...
        <div className="p-4 lg:hidden">
          ...
          <div className="avatar">
                  <div className="w-10 rounded-full border-2 border-blue-600">
                  {
                    user? (
                      <img src={user.photoURL} alt="" />
                    ) : (
            ...
            <div className="dropdown dropdown-end">
              <div onClick={()=>setToggle(!toggle)} tabIndex={0} role="button" className="btn m-1 text-xl">
              {
                toggle ? <RxCross2></RxCross2>  :  <IoMenu></IoMenu>
              }
              </div>
              <div>
                {
                  toggle ? (
                    <ul className="menu menu-sm dropdown-content mt-3 z-[1] p-2 shadow bg-base-100 rounded-box w-52 space-y-2">
                      <li className="btn"><Link to={'/'}>Home</Link></li>
                      <li className="btn">Profile</li>
                      <li className="btn">Update Profile</li>
                      <li><button onClick={handleLogOut} className="btn">Log Out</button></li>
                    </ul>
                  ) : null
                }
