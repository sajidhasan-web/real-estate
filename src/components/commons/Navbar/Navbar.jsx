...
const Navbar = () => {
  ...
  return (
    <div className="p-4  glass mb-10 border-b sticky top-0 z-10">
      <div className=" flex justify-between items-center h-16 ">
        <Link to={"/"} className="text-xl md:text-3xl font-bold text-secondary">
          Skyline<span className="text-primary">Solutions</span>
        </Link>
        ...
        <div className="p-4 lg:hidden">
          <div className="dropdown dropdown-bottom dropdown-end flex items-center gap-4">
            <div>
              {user ? (
                <div className="w-10 h-10 rounded-full border-2 border-blue-600 ">
                  {user?.photoURL
            ...
            <div className="dropdown dropdown-end">
              <div
                ...
                tabIndex={0}
                role="button"
                className="btn m-1 text-xl shadow-lg"
              >
                {toggle ? (
                  <RxCross2 className="h-6 w-6"></RxCross2>
                ) : (
                  <IoMenu className="h-6 w-6"></IoMenu>
                )}
              </div>
              <div>
                {toggle ? (
